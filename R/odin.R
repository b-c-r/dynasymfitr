...
consumer_resource_model_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "consumer_resource_model_rhs_dde",
      rhs_desolve = "consumer_resource_model_rhs_desolve",
      initmod_desolve = "consumer_resource_model_initmod_desolve"),
    dll = "dynasymfitr",
    user = c("e", "fmax", "K", "m", "n1_initial", "n2_initial", "nhalf", "q",
             "r"),
    ...
    registration = function() {
      if (FALSE) {
        .C("consumer_resource_model_rhs_dde", package = "dynasymfitr")
        .C("consumer_resource_model_rhs_desolve", package = "dynasymfitr")
        .C("consumer_resource_model_initmod_desolve", package = "dynasymfitr")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("consumer_resource_model_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "dynasymfitr")
    },

    update_metadata = function() {
      meta <- .Call("consumer_resource_model_metadata", private$ptr,
                    PACKAGE = "dynasymfitr")
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("consumer_resource_model_create", user, PACKAGE = "dynasymfitr")
    ...
    ir = function() {
      path_ir <- system.file("odin/consumer_resource_model.json", mustWork = TRUE,
                             package = "dynasymfitr")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("consumer_resource_model_set_user", private$ptr, user, PACKAGE = "dynasymfitr")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("consumer_resource_model_initial_conditions", private$ptr, t, PACKAGE = "dynasymfitr")
    },

    rhs = function(t, y) {
      .Call("consumer_resource_model_rhs_r", private$ptr, t, y, PACKAGE = "dynasymfitr")
    },
    ...
    contents = function() {
      .Call("consumer_resource_model_contents", private$ptr, PACKAGE = "dynasymfitr")
    },
...
consumer_resource_model <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("consumer_resource_model")
  consumer_resource_model_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(consumer_resource_model) <- "odin_generator"
attr(consumer_resource_model, "generator") <- consumer_resource_model_
