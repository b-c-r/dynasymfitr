...
rma_model_ <- R6::R6Class(
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "rma_model_rhs_dde",
      rhs_desolve = "rma_model_rhs_desolve",
      initmod_desolve = "rma_model_initmod_desolve"),
    dll = "dynasymfitr",
    user = c("f_max", "K", "m", "n_half", "n1_initial", "n2_initial", "r"),
    ...
    registration = function() {
      if (FALSE) {
        .C("rma_model_rhs_dde", package = "dynasymfitr")
        .C("rma_model_rhs_desolve", package = "dynasymfitr")
        .C("rma_model_initmod_desolve", package = "dynasymfitr")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("rma_model_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "dynasymfitr")
    },

    update_metadata = function() {
      meta <- .Call("rma_model_metadata", private$ptr,
                    PACKAGE = "dynasymfitr")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("rma_model_create", user, PACKAGE = "dynasymfitr")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/rma_model.json", mustWork = TRUE,
                             package = "dynasymfitr")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("rma_model_set_user", private$ptr, user, PACKAGE = "dynasymfitr")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("rma_model_initial_conditions", private$ptr, t, PACKAGE = "dynasymfitr")
    },

    rhs = function(t, y) {
      .Call("rma_model_rhs_r", private$ptr, t, y, PACKAGE = "dynasymfitr")
    },
    ...
    contents = function() {
      .Call("rma_model_contents", private$ptr, PACKAGE = "dynasymfitr")
    },
...
rma_model <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("rma_model")
  rma_model_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(rma_model) <- "odin_generator"
attr(rma_model, "generator") <- rma_model_
